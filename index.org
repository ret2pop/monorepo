...
#+HTML_HEAD_EXTRA: <link rel="preload" fetchpriority="high" as="image" href="/img/logo.webp" type="image/webp">
...
My programming projects can be found on my [[https://git.nullring.xyz/][git server]]; other projects that do not directly pertain
...
website (with my nix config):
#+begin_src shell :exports code :results silent
  remote-build preston@nullring.xyz
#+end_src
* Donate
